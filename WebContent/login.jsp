		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="/shopstore/admin/index.jsp">后台</a></li>
						...
						<li><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="regisger.jsp">Register</a></li>
					</ul>
				</div>
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href=".action">Best Store <span>Shop anywhere</span></a></h1>
				</div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				<li><a href=".action"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
		...
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				...
				<form action="login.action" method="post">
					...
					<input type="password" placeholder="请密码" required=" " name="pwd">
					<span>${login_error_msg}</span>
					<input type="text" placeholder="请输入验证码" required=" "  name="code">
					<img id="img" src="code"><a onclick="change()" href="javascript:;">看不清换一个</a>
					<span>${code_error_msg}</span>
			...
			<p class="animated wow slideInUp" data-wow-delay=".5s"><a href="register.html">Register Here</a> (Or) go back to <a href="index.action">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- footer -->
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href=".action">Best Store <span>shop anywhere</span></a></h2>
			</div>
