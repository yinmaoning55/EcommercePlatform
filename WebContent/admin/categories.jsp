				...
				<div class="box col-md-12">
					<div class="box-inner">
						...
						<div class="box-content">
							<tr>
								<th><font size="4" color="black"><a
										class="ajax-link" href="userlist.do">用户ID</a></font></th>
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								<th><font size="4" color="black"><a href="index.jsp">主页</a></font></th>
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								<th><font size="4" color="black"><a
										href="adminlist.do">管理员列表</a></font></th>
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								<th><font size="4" color="black">用户列表</font></th>
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								<th><font size="4" color="black">类别列表</font></th>
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								...
								<th>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</th>
								<th><font size="4" color="black"><a
										href="category_add_root.jsp">添加根类别</a></font></th>
							</tr>
							<table
								...
								<tbody>
									...
									<c:forEach var="category" items="${categories}">
										...
										<tr>
											...
											<td class="center">${category.descr}</td>
											<td class="center">${category.pid}</td>
											<td>${category.leaf}</td>
											<td>${category.grade }</td>
											<td class="center"><c:choose>
													<c:when test="${category.grade>=3}">
														<a href="" class="btn btn-success"><i
															class="glyphicon glyphicon-zoom-in icon-white"></i>不能在添加子类别了</a>

													</c:when>
													<c:otherwise>

														<a class="btn btn-success"
															href="categoryloadchild.do?pid=${category.id}"> <i
															class="glyphicon glyphicon-zoom-in icon-white"></i> 添加子类别
														</a>
													</c:otherwise>


												</c:choose> <a class="btn btn-info" href="#"> <i
													class="glyphicon glyphicon-edit icon-white"></i> 修改
											</a> <a class="btn btn-danger" href="categorydelete.do?id=${category.id}&pid=${category.pid}"> <i
