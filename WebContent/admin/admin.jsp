...
<!-- 添加对话框 -->
        <div class="box-icon">
            <a href="#" class=" btn-setting  "><i class="glyphicon glyphicon-cog"></i></a>
    ...
    <tr >
        ...
        <th><font size="4" color="black"><a href="index.jsp">主页</a></font></th>
         <th>  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </th> 
                <th><font size="4" color="black">管理员列表</font></th>
         <th>  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </th>
        ...
        <th>  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </th>
         <th><font size="4" color="pink"><a class="ajax-link" href="add.jsp">添加用户</a></font></th>
    </tr>
   ...
   <tr>
        ...
        <td   class="center">
            ...
            <a class="btn btn-info" href="adminload.do?id=${admin.id} ">
          ...
          修改
            ...
            <a   href="javascript:;" onclick="del(${admin.id })" class="btn btn-danger" >
