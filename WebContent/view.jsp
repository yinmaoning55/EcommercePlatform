			...
			<div class="logo-nav">
				...
				<div class="header-right">
					<div class="cart box_1">
						...
						<p><a href="Cartload.action?id=${p.id}" class="simpleCart_empty">Empty Cart</a></p>
						<div class="clearfix"> </div>
					</div>	
				</div>
				<div class="clearfix"> </div>
	...
	<div class="single">
		...
		<session>
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					...
					<form action="productaddtocart.action" method="post">
					<input type="hidden" name="id" value="${p.id}">
					<h3>${p.name}</h3>
					<h4><span class="item_price">${p.normalprice}</span> - ${p.memberprice}</h4>
					<div class="rating1">
					...
					<div class="color-quality">
						...
						<div class="color-quality-right">
							<h5>数量 :</h5>
								...
								<input type="text" name="pcount" id="qty"></input>

						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="occasional">
						<h5>类别 :<a>${p.category.name }</a></h5>
						
					<div class="occasion-cart">
						<button type="submit" title="添加购物车" ><class="item_add" >添加到购物车</a></button>
					</div>
					<div class="social">
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
				<p>Copyright &copy; 2016.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank"> </a> - Collect from <a href="http://www.cssmoban.com/"  target="_blank"></a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
