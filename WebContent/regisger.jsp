				...
				<div class="header-grid-left animated wow slideInLeft"
					...
					<ul>
						...
						<li><i class="glyphicon glyphicon-earphone"
							aria-hidden="true"></i>+1234 <span>567</span> 892</li>
						<li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a
							href="login.jsp">Login</a></li>
						<li class="active"><i class="glyphicon glyphicon-book"
							aria-hidden="true"></i><a href="register.jsp">Register</a></li>
					</ul>
				</div>
			...
			<div class="login-form-grids">
				...
				<form class="animated wow slideInUp" data-wow-delay=".5s"
					...
					<input type="text" placeholder="请输入用户名" required=" "
						name="username"> <input type="text" placeholder="请输入电话"
						required=" " name="phone">
					...
					<div class="register-check-box animated wow slideInUp"
						...
						<div class="check">
							<label class="checkbox"><input type="checkbox"
								name="checkbox"><i> </i>Subscribe to Newsletter</label>
						</div>
					</div>
					...
					<input type="password" placeholder="请输入密码" required=" " name="pwd1">
					<input type="password" placeholder="再次输入密码" required=" "
						name="pwd2"> <span>${reg_error_msg}</span>
