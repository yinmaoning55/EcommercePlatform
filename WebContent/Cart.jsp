		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.html">���ﳵ<span>Shop anywhere</span></a></h1>
				</div>
		...
		<div class="container">
			...
			<div class="checkout-right animated wow slideInUp" data-wow-delay=".5s">
				<table class="timetable_sub">
					...
					<tr class="rem1">
						<td class="invert">${c.product.name}</td>
						<td class="invert-image"><a href="single.html"><img src="images/22.jpg" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
						<input type="button" value="-" onclick="handler(${c.product.id},'-')">
						<input type="text" value="${c.pcount}" size="4">
						<input type="button" value="+" onclick="handler(${c.product.id},'+')">
						
						
						</td>
						
						<td class="invert">${c.product.id}</td>
						<td class="invert">${c.product.normalprice}</td>
						...
						<td class="invert">
							...
							<div class="rem">
								 <a href="${pageContext.request.contextPath}/Cartdelete.action?id=${c.product.id}">ɾ��</a>
							</div>
...
function handler(id,flag) {
	...
	var url="http://localhost:8080/shopstore/add.action?id="+id;
	if(flag=='+'){
		url+="&pcount=1";
	}else if(flag=='-'){
		url+="&pcount=-1";
